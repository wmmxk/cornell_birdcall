...
class Parameters(object):
    def __init__(self, hparams=None):
        ...
        self.bckgrd_aug_dir = "/home/bizon/Data/cornell_birdcall/data/pinknoise" 
        self.secondary_bckgrd_aug_dir = "/home/bizon/Data/cornell_birdcall/data/pinknoise"
        ...
        self.train_ds_params = {
            "root_dir": get_dict_value(Path("/home/bizon/Data/cornell_birdcall/data/")), # Set to Path("data/") if not using Kaggle Kernel if the data is in data/
            "csv_dir": Path(f"/home/bizon/Data/cornell_birdcall/data/birds5folds/fold_{self.fold}_train.csv"),
            "period": self.PERIOD,
            "bird_code": BIRD_CODE,
        ...
        self.valid_ds_params = {
            "root_dir": get_dict_value(Path("/home/bizon/Data/cornell_birdcall/data/")), # Set to Path("data/") if not using Kaggle Kernel if the data is in data/
            "csv_dir": Path(f"/home/bizon/Data/cornell_birdcall/data/birds5folds/fold_{self.fold}_test.csv"),
            "period": self.PERIOD,
            "bird_code": BIRD_CODE,
            "inv_ebird_label":INV_EBIRD_LABEL,
        ...
        self.checkpoint_params = {
            "save_dir":f"/home/bizon/Data/cornell_birdcall/data/{self.name}", # Path to save the checkpoints
            "n_saved":2,
