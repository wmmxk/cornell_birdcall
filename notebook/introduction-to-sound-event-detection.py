# source https://www.kaggle.com/hidehisaarai1213/introduction-to-sound-event-detection?select=best.pth
...
INPUT_ROOT = Path('/home/bizon/Data/cornell_birdcall/data')
...
# model
model_dir = "/home/bizon/Data/cornell_birdcall/model/introduction_to_SED"
model_config["classes_num"] = 527
model = PANNsCNN14Att(**model_config)
weights = torch.load(f"{model_dir}/Cnn14_DecisionLevelAtt_mAP0.425.pth")
# Fixed in V3
...
weights_path = "/home/bizon/Data/cornell_birdcall/model/introduction_to_SED/best.pth"
